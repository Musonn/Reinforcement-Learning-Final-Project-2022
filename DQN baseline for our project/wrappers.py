...
From https://github.com/openai/baselines/blob/tf2/baselines/common/atari_wrappers.py
"""
...
class NoopResetEnv(gym.Wrapper):
    ...
    def reset(self, **kwargs):
        ...
        if self.override_num_noops is not None:
            ...
            noops = self.unwrapped.np_random.integer(1, self.noop_max + 1)  # pylint: disable=E1101
        assert noops > 0
        obs = None
