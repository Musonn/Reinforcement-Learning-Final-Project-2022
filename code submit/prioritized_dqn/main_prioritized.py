# The algorithm of Prioritized Experience Replay was loosely adapted from
...
for i in range(frames):
    ...
    if done:
        print(episode_num,episode_reward,step_size)
...
#np.savetxt('results/rew/rewards_per_episode.csv', all_rewards, delimiter=',', fmt='%1.3f')
#np.savetxt('results/steps_per_episode.csv', all_steps, delimiter=',', fmt='%1.3f')
#ewards_dqn_nature = np.loadtxt('results/rewards_per_episode.csv', delimiter=',')
#steps_dqn_nature = np.loadtxt('results/steps_per_episode.csv', delimiter=',')
##plt.subplot(211)
#plt.plot(rewards_dqn_nature, label='Rewards Per Episode')
#plt.ylabel('Reward')
#plt.title('Rewards per Episode for DQN implemented on Pong')
#plt.subplot(212)
#plt.plot(steps_dqn_nature, label='Steps Per Episode')
#plt.ylabel('Steps')
#plt.title('Steps per Episode for DQN implemented on Pong')
#plt.xlabel('Episode')


#plt.legend()
plt.savefig('results/results_per_episode.png')
plt.show()
